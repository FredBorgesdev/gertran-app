...
export class MonitoringListComponent implements OnInit, OnDestroy {
  ...
  monitoringColumns = [
    ...
    {title: 'Ign', nzLeft: true, style: 'z-index: 999', width: '40px'},
    {title: 'Ale', nzLeft: true, style: 'z-index: 999', width: '40px', gertranStaffOnly: true},
    {title: 'Automação', nzLeft: true, style: 'z-index: 999', width: '90px'},
    {title: 'Mapa', nzLeft: true, style: 'z-index: 999', width: '50px'},
    {title: '%', nzLeft: true, style: 'z-index: 999', width: '100px'},
    {title: 'Vel', nzLeft: true, style: 'z-index: 999', width: '50px'},
    {title: 'Cliente', nzLeft: true, style: 'z-index: 999', width: '110px'},
    {title: 'Data/Hora', nzLeft: true, style: 'z-index: 999', width: '90px'},
    {title: 'Posição', nzLeft: true, style: 'z-index: 999', width: '110px'},
    {title: 'Status V.', nzLeft: true, style: 'z-index: 999', width: '80px', gertranStaffOnly: true},
